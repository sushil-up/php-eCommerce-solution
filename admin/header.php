...
<?php
    ...
    if ( !isUserLoggedIn() || $userdata['role'] != 'admin' ) redirect(BASE_URL."/login");
    $username = $userdata['username'];
    $email = $userdata['email'];
    $phone = $userdata['phone'];
    $imagename = $userdata['image'];
?>
<!-- END User Loggedin Check -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?php //echo ADMIN_URL;?>/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        </div> -->
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a target="_blank" href="<?php echo BASE_URL;?>" class="nav-link">Shop</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="<?php echo ADMIN_URL; ?>/dist/img/user1-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="<?php echo ADMIN_URL; ?>/dist/img/user8-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="<?php echo ADMIN_URL; ?>/dist/img/user3-128x128.jpg" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
                ...
                <a href="<?php echo BASE_URL; ?>/logout" class="text-danger">Logout</a>
</li>
