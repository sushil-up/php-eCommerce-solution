              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" aria-label="Default select example" name="role">
                        <option <?php if ($userObj['role'] == 'admin') echo "selected"; ?> value="admin">Admin</option>
                        <option <?php if ($userObj['role'] == 'customer') echo "selected"; ?> value="customer">Customer</option>
                    </select>
                </div>
