    ...
    <div class="col-md-4 mb-5">
        <div class="card h-100">
            ...
            <div class="text-center">
                ...
                $heartClass = (empty($wishlist)) ? "fa-heart-o" : "hidden"; ?>
                    <a href="<?php echo BASE_URL?>/wishlist-add/<?php echo $value['slug'] ?>" class="btn btn-danger btn-sm d-block activeAjax ">Remove</a>
                    </a>
